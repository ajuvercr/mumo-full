...
if($_SERVER['HTTP_HOST'] != "db"){
  ...
  $url = "https://www.yourdomain.something"; //base url ending on .be or .com
  $domain = "mumodashboard.be"; //short url like it would be shown in an email adress behind the @
  $clustername = "Mumo"; 
  $logo = "assets\images\logo\mumoLogo.png";
  $logo_w = "assets\images\logo\mumoLogoW.png"; //This can be changed to a different logo if desired
}else{
  //Settings of the db. Only needed whilst debuggin offline
  $con = mysqli_connect("db", "user", "userpass", "mumo_test", 3306);
  $url = "http://db/MuMo-Dash"; //base url ending on .be or .com
  $domain = "db";
  $clustername = "Mumo";
  $logo = "assets\images\logo\Mumo final.png"; //This can be changed to a different logo if desired
...
// display the link to reset the password
$show_link = true; //Make the settings page show the login url's so they can be shared to others without the direct link trough mail:
